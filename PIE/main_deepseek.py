...
while (tot_trial > 0): 
    ...
    if all_pass:
        ...
        output_file = open(f"./output_pse_code/deepseek/{task}.txt", "w")
...
t2 = time.time()
print(f"trial time == {t2 - t1}s")
trial_number = original_tot_trial - tot_trial
print(f"avg time == {(t2 - t1) / trial_number:.4f}s")
